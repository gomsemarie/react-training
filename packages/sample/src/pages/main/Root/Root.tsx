  ...
  return <div data-page="root">
    ...
    <div className="content-box">
      <Root.Training title={tl[0].title} desc={tl[0].desc}>
        <Root.StyledText><a className="link" onClick={() => navigator('/sample')}>Go Sample Page</a></Root.StyledText>
      </Root.Training>
...
namespace Root {
  ...
  export function Counter (props: CounterProps) {
    ...
    return <div data-component="root.counter">
    <div className="count-box"><input type="text" value={count} readOnly/></div>
